...
const Contact = () => {
  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-20 lg:px-8">
      <div
        aria-hidden="true"
        className="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-40rem]"
      >
        <div
          style={{
            clipPath:
          ...
          //   className="relative left-1/2 translate-y-52 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-28 -rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
        />
      </div>
      ...
      <div className="mt-10">
        <hr />
        <div className="mt-5 align-center justify-center flex">
