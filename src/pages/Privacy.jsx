...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="mb-4">Last updated: December 02, 2024</p>
      <p>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          ...
          "Us" or "Our" in this Agreement) refers to CATTA FASHIONS LLP, 11/259,
          Cherur Road Kazhukanchina, Cherur, PO; Vengara, Malappuram, Kerala,
          India - PIN 676304.
        </li>
        <li>
      ...
      <h2 className="text-xl font-semibold mt-6">Sharing Your Personal Data</h2>
      ...
      <h3 className="font-semibold mt-4">Business Transactions</h3>
      <p>
      ...
      <h3 className="font-semibold mt-4">Law enforcement</h3>
      <p>
      ...
      <h3 className="font-semibold mt-4">Other legal requirements</h3>
      <p>
      ...
      <h2 className="text-xl font-semibold mt-6">Links to Other Websites</h2>
      <p>
